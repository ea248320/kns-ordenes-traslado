...
// Se publica en GitHub Pages bajo /kns-ordenes-traslado/ (el nombre del
// repo), así que todas las rutas absolutas necesitan ese prefijo.
const BASE = '/kns-ordenes-traslado/'
